...
<div class="row">
	<div class="col-sm-4">
		<table class="table table-striped table-hover table-condensed">
			...
			<tbody>
				<tr>
					<td class="col-sm-8 col-md-6 col-lg-5"><strong>{$text->__('ZLP_AG_F_SUBSTRATE')}</strong></td>
					<td class="col-sm-4 col-md-6 col-lg-7">{$values['ZLP_AG_F_SUBSTRATE']}</td>
				</tr>
				<tr>
				...
				<tr>
					<td><strong>{$text->__('ZLP_AG_F_PRINT_METHOD')}</strong></td>
					<td>{$text->__($values['ZLP_AG_F_PRINT_METHOD'])}</td>
				</tr>
				<tr>
					<td><strong>{$text->__('ZLP_AG_F_CYLINDER')}</strong></td>
					<td>{$values['ZLP_AG_F_CYLINDER']}</td>
				</tr>
				<tr>
					<td><strong>{$text->__('ZLP_AG_F_REPEAT_LENGTH')}</strong></td>
					<td>{$values['ZLP_AG_F_REPEAT_LENGTH']}</td>
				</tr>
				<tr>
					<td><strong>{$text->__('ZLP_CAD_F_MATERIAL_WIDTH')}</strong></td>
					<td>{$values['ZLP_CAD_F_MATERIAL_WIDTH']}</td>
				</tr>
			</tbody>
		</table>
	</div>
