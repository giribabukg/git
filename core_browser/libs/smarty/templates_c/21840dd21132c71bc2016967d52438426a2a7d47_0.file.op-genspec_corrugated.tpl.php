...
/* Smarty version 3.1.29, created on 2016-10-12 15:36:22
  from "/var/www/html/core/templates/op-genspec_corrugated.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57fe58764e42c4_09816402',
  'file_dependency' => 
  array (
    '21840dd21132c71bc2016967d52438426a2a7d47' => 
    array (
      0 => '/var/www/html/core/templates/op-genspec_corrugated.tpl',
      1 => 1476285666,
      2 => 'file',
    ),
  ),
...
function content_57fe58764e42c4_09816402 ($_smarty_tpl) {
?>
<!-- genspec corrugated -->
<div class="row">
	<div class="col-sm-4">
		<table class="table table-striped table-hover table-condensed">
			...
			<tbody>
				<tr>
					<td class="col-sm-8 col-md-6 col-lg-5"><strong><?php echo $_smarty_tpl->tpl_vars['text']->value->__('ZLP_AG_C_CORRUGATED_TYPE');?>
</strong></td>
					<td class="col-sm-4 col-md-6 col-lg-7"><?php echo $_smarty_tpl->tpl_vars['values']->value['ZLP_AG_C_CORRUGATED_TYPE'];?>
</td>
				</tr>
				<tr>
				...
				<tr>
					<td><strong><?php echo $_smarty_tpl->tpl_vars['text']->value->__('ZLP_AG_C_SHEET_FORMAT');?>
</strong></td>
					<td><?php echo $_smarty_tpl->tpl_vars['values']->value['ZLP_AG_C_SHEET_FORMAT'];?>
</td>
				</tr>
				<tr>
					<td><strong><?php echo $_smarty_tpl->tpl_vars['text']->value->__('ZLP_AG_C_PRINTSIZE_MAX_WIDTH');?>
</strong></td>
					<td><?php echo $_smarty_tpl->tpl_vars['values']->value['ZLP_AG_C_PRINTSIZE_MAX_WIDTH'];?>
</td>
				</tr>
				<tr>
					<td><strong><?php echo $_smarty_tpl->tpl_vars['text']->value->__('ZLP_AG_C_PRINTSIZE_MAX_HEIGHT');?>
</strong></td>
					<td><?php echo $_smarty_tpl->tpl_vars['values']->value['ZLP_AG_C_PRINTSIZE_MAX_HEIGHT'];?>
</td>
				</tr>
				<tr>
					<td><strong><?php echo $_smarty_tpl->tpl_vars['text']->value->__('ZLP_AG_C_PRINTSIZE_MIN_WIDTH');?>
</strong></td>
					<td><?php echo $_smarty_tpl->tpl_vars['values']->value['ZLP_AG_C_PRINTSIZE_MIN_WIDTH'];?>
</td>
				</tr>
				<tr>
					<td><strong><?php echo $_smarty_tpl->tpl_vars['text']->value->__('ZLP_AG_C_PRINTSIZE_MIN_HEIGHT');?>
</strong></td>
					<td><?php echo $_smarty_tpl->tpl_vars['values']->value['ZLP_AG_C_PRINTSIZE_MIN_HEIGHT'];?>
</td>
				</tr>
			</tbody>
		</table>
