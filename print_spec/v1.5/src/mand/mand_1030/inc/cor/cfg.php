...
define('MANDATOR_NAME', 'QTicketing');
...
define('NEW_MID', 		  1030);
    ...
    CCor_Cfg::set('job-art.mask.tabs', array('job'));
    ...
    //CCor_Cfg::set('menu-aktivejobs', array('job-sec','job-art','job-com')); // Verf������������������������������������������������������gbare Items unter dem Men������������������������������������������������������ "Aktive Jobs".
    CCor_Cfg::set('menu-aktivejobs', array('job-sec')); // Verf������������������������������������������������������gbare Items unter dem Men������������������������������������������������������ "Aktive Jobs".
    CCor_Cfg::set('menu-archivjobs', array('sec')); // Verf������������������������������������������������������gbare Items unter dem Men������������������������������������������������������ "Archiv".
    CCor_Cfg::set('menu-projektitems', array('job_sec')); // Verf������������������������������������������������������gbare Job-Typen i. Projekt-Items um ein neu Job anzulegen
