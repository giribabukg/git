 ...
 * @version $Rev: 43 $
 * @date $Date: 2012-03-27 16:07:13 +0800 (Tue, 27 Mar 2012) $
 ...
 */
   ...
   */
    define('MANDATOR', 			'new'); // Dateienkürzel (KLEINgeschrieben,genau 3 Buchstaben!)
    define('MANDATOR_NAME', 'Neuermandantenname'); // Mandantenname (EIN Wort, 1. Buchstabe GROSSgeschrieben)
    define('KNR_REP', 			'KNR_REP'); // KNR_REP: Kundennummer für Repro etc.
    define('KNR_ART', 			'KNR_ART'); // KNR_ART: Kundennummer für Artwork/Agentur
    define('NEW_MID', 		  999); // MID > 0 !!! MandantenID wird auch i.d. Datenbank al_sys_mand (s.u.) eingetragen
    ...
    // Projekte
    CCor_Cfg::set('job-pro.keyw', array('project_no','project_name')); //Alias-Namen für d. Erstellung des Projekt-Stichwortes.
    
    // Projektfelder, die bei der Projektzuordnung i.d. Job geschrieben werden.
    CCor_Cfg::set('job-pro.fields', array('project_name','project_no','produktgruppe','agentur'));
    ...
    CCor_Cfg::set('menu-aktivejobs', array('job-all','job-art','job-rep','job-sec','job_adm','job-mis')); // Verfügbare Items unter dem Menü "Aktive Jobs".
    CCor_Cfg::set('menu-archivjobs', array('pro','art','rep','sec','adm','mis')); // Verfügbare Items unter dem Menü "Archiv".
    CCor_Cfg::set('menu-projektitems', array('job_art','job_rep','job_sec','job_adm','job_mis')); // Verfügbare Job-Typen i. Projekt-Items um ein neu Job anzulegen
