...
{
	//jq("*[name='val[chk_L]']").val("");
	//jq("*[name='val[chk_A]']").val("");
	//jq("*[name='val[chk_B]']").val("");
	
	jq("*[name='val[printl]']").val("");
	jq("*[name='val[printa]']").val("");
	jq("*[name='val[printb]']").val("");
	
	
	theForm.DE1976.value = "";
	jq("*[name='val[DE1994_GraphicArts]']").val("");
	theForm.DE1994_Textiles.value = "";
	
	jq("*[name='val[decyan]']").val("");
	theForm.DECMC_11.value = "";
	jq("*[name='val[DECMC_21]']").val("");
}
...
{
	jq("*[name='val[chkl]']").val(Lab1.L.toFixed(2));
	jq("*[name='val[chka]']").val(Lab1.a.toFixed(2));
	jq("*[name='val[chkb]']").val(Lab1.b.toFixed(2));
	
	jq("*[name='val[printl]']").val(Lab2.L.toFixed(2));
	jq("*[name='val[printa]']").val(Lab2.a.toFixed(2));
	jq("*[name='val[printb]']").val(Lab2.b.toFixed(2));
	
	theForm.DE1976.value = DE1976.toFixed(2);
	theForm.DE1994_Textiles.value = DE1994_Textiles.toFixed(2);
	jq("*[name='val[DE1994_GraphicArts]']").val(DE1994_GraphicArts.toFixed(2));
	jq("*[name='val[decyan]']").val(DE2000.toFixed(2));
	theForm.DECMC_11.value = DECMC_11.toFixed(2);
	jq("*[name='val[DECMC_21]']").val(DECMC_21.toFixed(2));
}

function GetLab1(theForm)
{
	Lab1.L = GetNumber(jq("*[name='val[chkl]']").val());
	Lab1.a = GetNumber(jq("*[name='val[chka]']").val());
	Lab1.b = GetNumber(jq("*[name='val[chkb]']").val());
...
{
	Lab2.L = GetNumber(jq("*[name='val[printl]']").val());
	Lab2.a = GetNumber(jq("*[name='val[printa]']").val());
	Lab2.b = GetNumber(jq("*[name='val[printb]']").val());
