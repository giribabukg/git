...
class CInc_Usr_Mod extends CCor_Mod_Table {
  ...
  public function __construct($aCond = 0) {
    ...
    $lFields = array('anrede', 'firstname', 'lastname', 'company', 'location', 'department', 'pnr', 'email', 'email_from', 'email_replyto', 'phone', 'cnd', 'procnd', 'user', 'gadmin');
...
//check required fields empty or not
	...
	public function getMendatoryfie($lVals) {
	  $lEmail = CInc_Usr_Mod::isValidEmail(trim($lVals ['email']));
