 ...
 * @version $Rev: 14261 $
 * @date $Date: 2016-06-01 04:51:40 +0800 (Wed, 01 Jun 2016) $
...
class CInc_Job_List extends CHtm_List {
  ...
  protected function getTdWec_pi() {
    ...
    $lRet = $this -> printThumbnail($lThb, $lImg, $lJobId);

    return $this -> tdClass($lRet, 'w100 ac');
  }

  protected function printThumbnail($aImgPathThb, $aImgPathImg, $aJobId) {
    $lParams = array(
      'src' => $this -> mSrc,
      'jobid' => $aJobId
    );
