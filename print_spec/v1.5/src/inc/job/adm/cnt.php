<?php
class CInc_Job_Adm_Cnt extends CJob_Cnt {
  ...
  protected function actEdt() {
    ...
    $lVie = new CJob_Adm_Tabs($lJobId, $lPag);
    $lRet.= $lVie -> getContent();

    $lFrm = new CJob_Adm_Form('job-adm.sedt', $lJobId, $lJob, $lPag);
  ...
  protected function actSur() {
    ...
    $lVie = new CJob_Adm_Tabs(0);
    $lRet = $lVie -> getContent();

    $lFrm = new CJob_Adm_Form('job-adm.ssur', 0, $lSKU);
  ...
  protected function actSsur() {
    ...
    if ($lMod -> insert()) {
      ...
      $this -> redirect('index.php?act=job-adm.edt&jobid='.$lJobID.'&page='.$lPage);
    }
    $this -> redirect('index.php?act=job-adm.new');
  }
  ...
  protected function actNsub() {
    ...
    $lVie = new CJob_Adm_Tabs();
    $lRet.= $lVie -> getContent();

    $lFrm = new CJob_Adm_Form('job-adm.snsub', 0, $lJob);
  ...
  protected function actSnsub() {
    ...
    if ($lMod -> insert()) {
      $lJobId = $lMod -> getInsertId();
      $this -> redirect('index.php?act=job-adm.edt&jobid='.$lJobId.'&page='.$lPag);
    }
    $this -> redirect('index.php?act=job-adm.new');
  }
