 ...
 * @version $Rev: 9725 $
 * @date $Date: 2015-07-16 21:18:56 +0800 (Thu, 16 Jul 2015) $
...
*/
  ...
  public function getMenu() {
    ...
    $lLnk = "javascript:Flow.Std.popMain('".$lMen -> mDivId."')";
  ...
  */
  ...
  protected function getTdUnassign() {
    ...
    $lRet.= '<a class="nav" href="javascript:Flow.Std.cnfUnassign(\''.$this -> mDelLnk.$lJid.'&src='.$lSrc.'\', \''.LAN.'\')">';
