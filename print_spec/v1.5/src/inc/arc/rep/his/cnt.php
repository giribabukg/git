<?php
class CInc_Arc_Rep_His_Cnt extends CCor_Cnt {
  ...
  protected function actStd() {
    ...
    $lVie = new CArc_Rep_Tabs($lJid, 'his');
    $lRet.= $lVie -> getContent();

    $lVie = new CArc_His_List('rep', $lJid);
    $lRet.= $lVie -> getContent();
  ...
  protected function actNew() {
    ...
    $lVie = new CJob_His_Form('rep', $lJid, 'snew', 'arc');
    $lRet.= $lVie -> getContent();
  ...
  protected function actSnew() {
    $lJid = $this -> getReq('jobid');
    $lMod = new CJob_His_Mod('rep', $lJid);
  ...
  protected function actEdt() {
    ...
    $lVie = new CJob_His_Form('rep', $lJid, 'sedt', 'arc');
    $lVie -> load($lId);
    $lRet.= $lVie -> getContent();
