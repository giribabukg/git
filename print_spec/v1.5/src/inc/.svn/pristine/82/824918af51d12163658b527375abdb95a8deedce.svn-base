<?php
class CInc_Arc_Mis_His_Cnt extends CCor_Cnt {
  ...
  protected function actStd() {
    ...
    $lVie = new CArc_Mis_Tabs($lJid, 'his');
    $lRet.= $lVie -> getContent();

    $lVie = new CArc_His_List('mis', $lJid);
    $lRet.= $lVie -> getContent();
  ...
  protected function actNew() {
    ...
    $lVie = new CJob_His_Form('mis', $lJid, 'snew', 'arc');
    $lRet.= $lVie -> getContent();
  ...
  protected function actSnew() {
    $lJid = $this -> getReq('jobid');
    $lMod = new CJob_His_Mod('mis', $lJid);
  ...
  protected function actEdt() {
    ...
    $lVie = new CJob_His_Form('mis', $lJid, 'sedt', 'arc');
    $lVie -> load($lId);
    $lRet.= $lVie -> getContent();
