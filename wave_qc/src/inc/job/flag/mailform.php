<?php
class CInc_Job_Flag_Mailform extends CHtm_Form {

  public function __construct($aSrc, $aJobId, $aJob, $aFrm = 'his') {
    parent::__construct('job-flag.snewmail', 'New eMail', 'job-flag&src='.$aSrc.'&jobid='.$aJobId);
    ...
    $this -> getTemplate(CCor_Cfg::get('flag.notifytemplate', NULL));
