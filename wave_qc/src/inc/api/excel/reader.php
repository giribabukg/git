 ...
 * @version    CVS: $Id: reader.php 6 2012-02-21 08:50:56Z gemmans $
...
class CInc_Api_Excel_Reader {
  ...
  private function isDate($spos) {
    ...
    if ($this->formatRecords['xfrecords'][$xfindex]['type'] == 'date') {
      ...
      if ($this->formatRecords['xfrecords'][$xfindex]['type'] == 'number') {
        ...
        if ($this->formatRecords['xfrecords'][$xfindex]['type'] == 'other') {
          $this->reccode = $this->curformat = $this->formatRecords['xfrecords'][$xfindex]['code'];
  ...
  private function addcell($row, $col, $string, $raw = '') {
    ...
    if (isset($this->reccode))
      $this->sheets[$this->sn]['cellsInfo'][$row + $this->_rowoffset][$col + $this->_coloffset]['code'] = $this->reccode;
  ...
  public function getCell($aSheet, $aRow, $aCol) {
    $lRet = (isset($this -> data[$aSheet]['cells'][$aRow][$aCol])) ? $this -> data[$aSheet]['cells'][$aRow][$aCol] : NULL;
    return $lRet;
  }

  public function getCellArray($aSheet) {
    $lRet = (isset($this -> data[$aSheet]['cells'])) ? $this -> data[$aSheet]['cells'] : array();
  }
