<?php
class CInc_Gru_Crp_Step_Form extends CCor_Ren {
  ...
  protected function getPriv() {
    ...
    $lSql = 'SELECT stp_id,fla_id FROM al_gru_rig_stp WHERE gru_id='.$this -> mGid.' AND stp_id IN ('.$lSid.')';
    $lQry -> query($lSql);
  ...
  protected function getCont() {
    ...
    $lRet.= '<input type="hidden" name="act" value="gru-crp-Step.sedt" />'.LF;
