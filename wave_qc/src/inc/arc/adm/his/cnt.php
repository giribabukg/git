<?php
class CInc_Arc_Adm_His_Cnt extends CCor_Cnt {
  ...
  protected function actStd() {
    ...
    $lVie = new CArc_Adm_Tabs($lJid, 'his');
    $lRet.= $lVie -> getContent();

    $lVie = new CArc_His_List('adm', $lJid);
    $lRet.= $lVie -> getContent();
  ...
  protected function actNew() {
    ...
    $lVie = new CJob_His_Form('adm', $lJid, 'snew', 'arc');
    $lRet.= $lVie -> getContent();
  ...
  protected function actSnew() {
    $lJid = $this -> getReq('jobid');
    $lMod = new CJob_His_Mod('adm', $lJid);
  ...
  protected function actEdt() {
    ...
    $lVie = new CJob_His_Form('adm', $lJid, 'sedt', 'arc');
    $lVie -> load($lId);
    $lRet.= $lVie -> getContent();
