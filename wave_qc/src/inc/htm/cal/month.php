<?php
class CInc_Htm_Cal_Month extends CCor_Ren {
  ...
  protected function getHeader() {
    ...
    #}
    $lRet.= '<td class="th1 ac" colspan="'.($lCol).'" style="padding:0px;">';
    ...
    $lRet.= '<td class="th2 w30 ac">Mon</td>'.LF;
    $lRet.= '<td class="th2 w30 ac">Tue</td>'.LF;
    $lRet.= '<td class="th2 w30 ac">Wen</td>'.LF;
    $lRet.= '<td class="th2 w30 ac">Thu</td>'.LF;
    $lRet.= '<td class="th2 w30 ac">Fri</td>'.LF;
    $lRet.= '<td class="th2 w30 ac">Sat</td>'.LF;
    $lRet.= '<td class="th2 w30 ac">Sun</td>'.LF;
    $lRet.= '</tr>'.LF;
  ...
  protected function getHolidays() {
    $lRet = '';
    $lRet.= '<tr>';
    $lRet.= '<td class="th1 ac" colspan="'.$this -> mColCnt.'">Holidays</td>';
    $lRet.= '</tr>';
