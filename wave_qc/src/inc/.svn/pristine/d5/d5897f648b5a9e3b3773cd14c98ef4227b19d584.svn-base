<?php
class CInc_Arc_Art_His_Cnt extends CCor_Cnt {
  ...
  protected function actStd() {
    ...
    $lVie = new CArc_Art_Tabs($lJid, 'his');
    $lRet.= $lVie -> getContent();

    $lVie = new CArc_His_List('art', $lJid);
    $lRet.= $lVie -> getContent();
  ...
  protected function actNew() {
    ...
    $lVie = new CJob_His_Form('art', $lJid, 'snew', 'arc');
    $lRet.= $lVie -> getContent();
  ...
  protected function actSnew() {
    $lJid = $this -> getReq('jobid');
    $lMod = new CJob_His_Mod('art', $lJid);
  ...
  protected function actEdt() {
    ...
    $lVie = new CJob_His_Form('art', $lJid, 'sedt', 'arc');
    $lVie -> load($lId);
    $lRet.= $lVie -> getContent();
