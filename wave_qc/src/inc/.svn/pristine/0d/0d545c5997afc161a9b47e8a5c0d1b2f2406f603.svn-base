<?php
class CInc_Arc_Sec_His_Cnt extends CCor_Cnt {
  ...
  protected function actStd() {
    ...
    $lVie = new CArc_Sec_Tabs($lJid, 'his');
    $lRet.= $lVie -> getContent();

    $lVie = new CArc_His_List('sec', $lJid);
    $lRet.= $lVie -> getContent();
  ...
  protected function actNew() {
    ...
    $lVie = new CJob_His_Form('sec', $lJid, 'snew', 'arc');
    $lRet.= $lVie -> getContent();
  ...
  protected function actSnew() {
    $lJid = $this -> getReq('jobid');
    $lMod = new CJob_His_Mod('sec', $lJid);
  ...
  protected function actEdt() {
    ...
    $lVie = new CJob_His_Form('sec', $lJid, 'sedt', 'arc');
    $lVie -> load($lId);
    $lRet.= $lVie -> getContent();
