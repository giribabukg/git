<?php
class CInc_Arc_Sec_Form extends CArc_Form {
  ...
  public function __construct($aAct, $aJobId = 0, $aJob = NULL, $aPage = 'job') {
    ...
    $this -> addBtn('act', lan('lib.cancel'), 'go("index.php?act=arc-sec")', 'img/ico/16/cancel.gif', 'button', array('class' => 'btn w200' ));

    $this -> mTabs = new CArc_Sec_Tabs($this -> mJobId, $aPage);
