 ...
 * @version $Rev: 14377 $
 * @date $Date: 2016-06-06 16:07:04 +0200 (Mon, 06 Jun 2016) $
...
class CInc_Job_Header extends CCor_Tpl {
  ...
  */
  ...
  protected function onBeforeContent() {
    ...
    $lAttributes = $this -> mSvcFile -> getAttributes($this -> mJid);

    CJob_Image::setAttributes(array('src' => $this -> mSrc, 'jobid' => $this -> mJid, 'width' => 100, 'height' => 100));
    $lImage = CJob_Image::getImage($lAttributes['preview.path'].$lAttributes['preview.filename']);
    $this -> setPat('preview', $lImage);
  }
