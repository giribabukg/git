<?php
class CInc_Job_Flag_Fil_Form extends CHtm_Form {

  public function __construct($aSrc, $aJobId, $aFlagTyp = '', $aSubpath = '', $aDiv = '', $aFid = '') {
    parent::__construct('job-flag-fil.supload', lan('lib.upload').' '.lan('job-'.$aSrc.'.menu').' '.lan('lib.file').' '.jid($aJobId, TRUE));
