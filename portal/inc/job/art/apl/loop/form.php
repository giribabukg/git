<?php
class CInc_Job_Art_Apl_Loop_Form extends CHtm_Form {
  ...
  public function __construct($aSrc, $aJobId, $lCap, $aFla, $aApl, $aPrjMaster) {
    ...
    $this -> mIsw800 = !CCor_Cfg::get('wec.api.annotation', False);
  ...
  protected function getForm() {
    ...
    if (!CCor_Cfg::get('wec.api.annotation', False)) {
      ...
      $lRet.= $this -> getDiffIsw800().'<div class="th1" >'.lan('lib.annotations').'</div></div>';
    ...
    if ($this -> mIsw800) $lRet = $this -> getDiffIsw800().$lRet.'</div>';
  ...
  protected function getDiffIsw800() {
    if ($this -> mIsw800) {
      $lRet = '<div class="tbl w800">';
    } else {
      $lRet = '<div class="tbl w700">';
    }
    return $lRet;
  }

  protected function getFormTag() {
    $lRet = $this -> getDiffIsw800();
