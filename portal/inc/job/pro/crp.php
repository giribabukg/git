 ...
 * @version $Rev: 13436 $
 * @date $Date: 2016-04-13 15:15:57 +0200 (Wed, 13 Apr 2016) $
    ...
    if (!empty($aProIdlist)) {
      ...
      if (!$this -> mViewJoblist) {
        ...
        if (!empty($lSrcStaPro)) {
          ...
          $lSQL.= ' WHERE mand='.MID;
          $lSQL.= ' AND pro_id IN ('.$lProIdListAsStr.')';
          ...
          $lSql = 'SELECT pro_id, COUNT(*) AS SubAmount FROM al_job_sub_'.MID.' WHERE pro_id IN ('.$lProIdListAsStr.') AND del="N"'; //alle ProIds
