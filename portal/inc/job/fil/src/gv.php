<?php
class CInc_Job_Fil_Src_Gv extends CJob_Fil_Files {

  public function __construct($aSrc, $aJobId, $aSub = 'gv', $aDiv = '', $aFrom = 'sub', $aAge = 'job', $aDebug = FALSE, $aUploadButton = FALSE) {
    $lSub = 'gv';
  ...
  public function getIterator() {
    ...
    $lDir = $lCls -> getPath('globalvision');
