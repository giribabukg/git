...
class CInc_Job_Fil_Src_Pixelboxx extends CJob_Fil_Files {
      ...
      $aAge = 'job', $aDebug = FALSE)
  {
    ...
    $this->addColumn('date', lan('lib.file.time.modification'), FALSE, array(
        'id' => 'date'
    ));
  ...
  protected function getTdName()
  {
    ...
    $lRet.= '<a class="cp" onclick="Flow.Pbox.showDetails(\''.$lDoi.'\',\''.$this->mDiv.'\',\''.$this->mSrc.'\',\''.$this->mJobId.'\',\''.$this->mSub.'\',\''.$this->mAge.'\')">';
