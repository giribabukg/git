<?php
class CInc_Job_Mis_Cos_Cnt extends CCor_Cnt {
  ...
  public function actStd() {
    ...
    $lVie = new CJob_Mis_Tabs($lJid, 'cos');
    $lRet.= $lVie -> getContent();

    $lFrm = new CJob_Mis_Cos_List($lJid, $lJob);
  ...
  protected function actScos() {
    ...
    $this -> redirect('index.php?act=job-mis-cos&jobid='.$lJid);
  }
