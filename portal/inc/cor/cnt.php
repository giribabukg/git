 ...
 * @version     $Rev: 13791 $
 * @date        $Date: 2016-05-09 16:20:54 +0200 (Mon, 09 May 2016) $
...
class CInc_Cor_Cnt extends CCor_Obj {
  ...
  protected function actPvs() {
    $this -> mReq -> expect('pvs');
    $lPvs = $this -> mReq -> getVal('pvs');
    $lUsr = CCor_Usr::getInstance();
    $lUsr -> setPref($this -> mPrf.'.pvs', $lPvs);
    $this -> redirect();
  }
