    ...
    */
    ...
    if (!empty($this -> mIdx)) {
      if ('Y' == $lValue['image']){
        ...
        $lRet.= 'var lColRgb = window.opener.document.getElementById("c'.$this -> mCpp.'div'.$this -> mIdx.'");';
        $lRet.= 'if(lColRgb !== null) {';
        $lRet.= "  lColRgb.style.background='#'+col".$this -> mColorColumn.";";
        $lRet.= '}';
