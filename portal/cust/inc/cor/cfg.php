 ...
 * @version $Rev: 16956 $
 * @date $Date: 2016-10-25 11:25:38 +0200 (Tue, 25 Oct 2016) $
 ...
 */
   ...
   // $this -> mVal['db.pass'] = 't!KRd8m#';
    $this -> mVal['db.name'] = 'corebrowser';
    ...
    $this -> mVal['base.url'] = 'http://10.207.7.16/portal/';

    // Services
    $this -> mVal['svc.url']  = 'http://10.207.7.16/'.CUST_PORTAL.DS; //'http://www.st-packline.de/'.CUST_PORTAL.DS; 217.7.140.35 alte IP Adresse
    ...
    // $this -> mVal['smtp.host'] = 'mail2.5flow.eu';
