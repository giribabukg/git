...
define('NEW_MID', 		  1020);
    ...
    CCor_Cfg::set('job-art.mask.tabs', array('job','det'));
    ...
    CCor_Cfg::set('menu-aktivejobs', array('job-rep','job-art','job-sec','job-tra')); // Verf��gbare Items unter dem Men�� "Aktive Jobs".
    CCor_Cfg::set('menu-archivjobs', array('rep','art','sec','tra')); // Verf��gbare Items unter dem Men�� "Archiv".
    CCor_Cfg::set('menu-projektitems', array('job_art','job_sec','job_rep','job_tra')); // Verf��gbare Job-Typen i. Projekt-Items um ein neu Job anzulegen
	...
	CCor_Cfg::set('all-jobs_ALINK', array('art','rep','com','mis','adm','sec','tra'));
    ...
    CCor_Cfg::set('csv-exp.bymail', true);
    CCor_Cfg::set('csv-exp.tpl', 271);
