...
function ButtonClear3(theForm)
{
	...
	jq("*[name='val[debla]']").val("");
}

function ButtonCalculate3(theForm)
{
	GetLab1B(theForm);
	GetLab2B(theForm);
	DeltaE1976();
	...
	DeltaECMC(1.0, 1.0);
	DeltaECMC(2.0, 1.0);
	FillAllCells3(theForm);
}

function FillAllCells3(theForm)
{
	jq("*[name='val[btl]']").val(Lab1.L.toFixed(2));
	jq("*[name='val[bta]']").val(Lab1.a.toFixed(2));
	jq("*[name='val[btb]']").val(Lab1.b.toFixed(2));
	
	jq("*[name='val[bsl]']").val(Lab2.L.toFixed(2));
	jq("*[name='val[bsa]']").val(Lab2.a.toFixed(2));
	jq("*[name='val[bsb]']").val(Lab2.b.toFixed(2));
	
	jq("*[name='val[debla]']").val(DE2000.toFixed(2));
}

function GetLab1B(theForm)
{
	Lab1.L = GetNumber(jq("*[name='val[btl]']").val());
	Lab1.a = GetNumber(jq("*[name='val[bta]']").val());
	Lab1.b = GetNumber(jq("*[name='val[btb]']").val());
	
	Lab1.L = (Lab1.L < 0.0) ? 0.0 : (Lab1.L > 100.0) ? 100.0 : Lab1.L;
}

function GetLab2B(theForm)
{
	Lab2.L = GetNumber(jq("*[name='val[bsl]']").val());
	Lab2.a = GetNumber(jq("*[name='val[bsa]']").val());
	Lab2.b = GetNumber(jq("*[name='val[bsb]']").val());
