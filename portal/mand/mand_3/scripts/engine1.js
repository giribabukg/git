...
function ButtonClear1(theForm)
{
	...
	jq("*[name='val[demag]']").val("");
}

function ButtonCalculate1(theForm)
{
	GetLab1M(theForm);
	GetLab2M(theForm);
	DeltaE1976();
	...
	DeltaECMC(1.0, 1.0);
	DeltaECMC(2.0, 1.0);
	FillAllCells1(theForm);
}

function FillAllCells1(theForm)
{
	jq("*[name='val[mtl]']").val(Lab1.L.toFixed(2));
	jq("*[name='val[mta]']").val(Lab1.a.toFixed(2));
	jq("*[name='val[mtb]']").val(Lab1.b.toFixed(2));
	
	jq("*[name='val[msl]']").val(Lab2.L.toFixed(2));
	jq("*[name='val[msa]']").val(Lab2.a.toFixed(2));
	jq("*[name='val[msb]']").val(Lab2.b.toFixed(2));
	
	jq("*[name='val[demag]']").val(DE2000.toFixed(2));
}

function GetLab1M(theForm)
{
	Lab1.L = GetNumber(jq("*[name='val[mtl]']").val());
	Lab1.a = GetNumber(jq("*[name='val[mta]']").val());
	Lab1.b = GetNumber(jq("*[name='val[mtb]']").val());
	
	Lab1.L = (Lab1.L < 0.0) ? 0.0 : (Lab1.L > 100.0) ? 100.0 : Lab1.L;
}

function GetLab2M(theForm)
{
	Lab2.L = GetNumber(jq("*[name='val[msl]']").val());
	Lab2.a = GetNumber(jq("*[name='val[msa]']").val());
	Lab2.b = GetNumber(jq("*[name='val[msb]']").val());
