...
function ButtonCalculate2(theForm)
{
	...
	DeltaECMC(1.0, 1.0);
	DeltaECMC(2.0, 1.0);
	FillAllCells2(theForm);
}

function FillAllCells2(theForm)
{
	jq("*[name='val[ytl]']").val(Lab1.L.toFixed(2));
	jq("*[name='val[yta]']").val(Lab1.a.toFixed(2));
	jq("*[name='val[ytb]']").val(Lab1.b.toFixed(2));
	
	jq("*[name='val[ysl]']").val(Lab2.L.toFixed(2));
	jq("*[name='val[ysa]']").val(Lab2.a.toFixed(2));
	jq("*[name='val[ysb]']").val(Lab2.b.toFixed(2));
	
	jq("*[name='val[deyel]']").val(DE2000.toFixed(2));
}

function GetLab1Y(theForm)
{
	Lab1.L = GetNumber(jq("*[name='val[ytl]']").val());
	Lab1.a = GetNumber(jq("*[name='val[yta]']").val());
	Lab1.b = GetNumber(jq("*[name='val[ytb]']").val());
	
	Lab1.L = (Lab1.L < 0.0) ? 0.0 : (Lab1.L > 100.0) ? 100.0 : Lab1.L;
}

function GetLab2Y(theForm)
{
	Lab2.L = GetNumber(jq("*[name='val[ysl]']").val());
	Lab2.a = GetNumber(jq("*[name='val[ysa]']").val());
	Lab2.b = GetNumber(jq("*[name='val[ysb]']").val());
